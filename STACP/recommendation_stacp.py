...
def main():
    ...
    execution_time = open("../datasets/result/execution_time" + ".txt", 'w')
    execution_time.write(str(elapsed_time))

    rec_list = open("../datasets/result/reclist_top_" + str(top_k) + ".txt", 'w')
    #result_5 = open("../datasets/result/result_top_" + str(5) + ".txt", 'w')
    result_10 = open("../datasets/result/result_top_" + str(10) + ".txt", 'w')
    #result_15 = open("../datasets/result/result_top_" + str(15) + ".txt", 'w')
    ...
    for cnt, uid in enumerate(all_uids):
        ...
        if uid in ground_truth:
            ...
            overall_scores = [
                # comment the last factor to get NoCTX
            ...
            result_10.write('\t'.join([str(cnt), str(uid), str(precision_10), str(recall_10), str(nDCG_10)]) + '\n')
            ...
            result_20.write('\t'.join([str(cnt), str(uid), str(precision_20), str(recall_20), str(nDCG_20)]) + '\n')
...
if __name__ == '__main__':
    ...
    # change lambda to 1 to get NoTC
